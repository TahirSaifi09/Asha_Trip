...
export default function Form() {
  return (
    <div>
      <div className="w-full flex max-sm:flex-wrap gap-4 max-sm:px-2 bg-gray-100">
        <div className="pl-16 max-sm:pl-0 pr-4 max-sm:pr-0  py-4 h-full w-8/12 max-sm:w-full">
          <div className="w-full px-4 py-4 rounded-lg shadow-xl bg-white items-center">
            <ul className="flex max-lg:flex-wrap items-center gap-5">
              <li className="w-4/12 max-lg:w-full flex text-center items-center gap-4 ">
                ...
                <hr className="border-2 w-5/12 max-sm:hidden max-sm:w-full"></hr>
              </li>
              <li className="w-4/12 max-sm:w-full flex items-center gap-4 ">
              ...
              <li className="flex items-center w-4/12 max-sm:w-full gap-4">
                <button className="h-8 w-8 bg-gray-200 text-xl text-center font-medium border rounded-full">
                  3
                </button>
                <h1 className="">Finel step</h1>
                <hr className="border-2 w-5/12 max-lg:w-full max-sm:hidden"></hr>
              </li>
            </ul>
          </div>
          <form>
            ...
            <div className="bg-white w-full mt-8 p-6 max-sm:p-4 rounded-lg shadow-lg">
              <div className="w-1/2 max-sm:w-full ">
                ...
                <div className="text-gray-400 text-sm font-medium max-sm:font-normal">
                  ...
                  <div className="text-lg max-sm:text-sm font-medium py-4 flex gap-2">
            ...
            <div className="bg-white w-full mt-8 px-6 max-sm:px-4 max-sm:py-5 py-10 rounded-lg shadow-lg">
        ...
        <div className="w-4/12 max-sm:w-full max-sm:pr-0 bg-gray-100 pr-16 py-4">
          <div>
            <div className="bg-white rounded-lg shadow-lg">
              <div className="px-4 py-3 w-full rounded-t-lg bg-slate-300 text-2xl max-sm:text-xl font-medium">
                <p>Your Booking Details</p>
              </div>
              <div className="flex text-center items-center max-sm:gap-4 justify-between px-8 max-sm:px-4 py-4">
                <div className="">
              ...
              <div className="flex justify-between px-8 max-sm:px-4 pb-8 py-2">
                <div className="py-2">
          ...
          <div>
            <div className="bg-white rounded-lg shadow-lg mt-8">
              ...
              <div className="flex justify-between px-8 max-sm:px-4 py-4 max-sm:pt-4">
                <div className="">
                  <p>Adult x 1</p>
              ...
              <div className="flex justify-between px-8 max-sm:px-4 py-4 max-sm:py-2">
                <div className="">
                  <p>Room Service</p>
                  <p className="text-sm font-medium text-gray-500">
                    Lorem ipsum dolor sit amet consectetur.
              ...
              <hr className="border-gray-400"></hr>
              <div className="flex text-2xl max-sm:text-lg font-medium justify-between p-8 max-sm:p-4">
                <p>Deal / Discount</p>
                <p>$40</p>
              </div>
              <div className="flex text-2xl max-sm:text-lg font-medium justify-between pb-8 max-sm:pb-4 px-8 max-sm:px-4 ">
                <p>Total</p>
                <p>$600</p>
              </div>
            </div>
